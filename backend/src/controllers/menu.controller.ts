...
export const createMenuItem = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const schema = z.object({
      ...
      isMultiSize: z.boolean().default(false).optional(),
      halfPrice: z.number().positive().optional().nullable(),
      familyPrice: z.number().positive().optional().nullable(),
...
export const updateMenuItem = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const schema = z.object({
      ...
      isMultiSize: z.boolean().optional(),
      halfPrice: z.number().positive().optional().nullable(),
      familyPrice: z.number().positive().optional().nullable(),
